---
pagetitle: "Secure (Probabilistic) Machine Learning — Roi Naveiro"
---
...
## Amodei's call to slow AI development {#motivation-pacing .headline-slide}

::: {.headline-content}
![](assets/headline-amodei-pacing.png){width=1080px fig-alt="A typeset excerpt of a Washington Post headline reporting Amodei's call to allow time for AI safety."}
...
**Sources:** [The Washington Post / AP](https://www.washingtonpost.com/business/2026/09/12/anthropic-ai-dario-amodei/5cc3cc44-aec8-11f1-b498-8697f35a6743_story.html), 12 September 2026; Dario Amodei, [We Must Pace the Frontier](https://darioamodei.com/post/we-must-pace-the-frontier).
:::

## Amodei's stated concerns {#motivation-two-reasons}
...
## What was the Hugging Face incident? {#motivation-incident-transition .transition-slide}
...
## The ExploitGym evaluation {#motivation-exploitgym}
...
## Agents crossed the sandbox boundary {#motivation-escape}
...
## Seeking private benchmark data {#motivation-incident-why}
...
## Compromising the dataset pipeline {#motivation-incident-mechanism}
...
## The intrusion did not improve the score {#motivation-incident-result}
...
## AI-assisted model development {#motivation-acceleration}
...
## Commercial incentives and alternative explanations {#motivation-other-reasons}
...
## Risks of agent coordination {#motivation-coordination-transition .transition-slide}

::: {.transition-copy}
::: {.transition-main}
Coordinating agents can **amplify mistakes**
:::
...
## Uncertainty about agent outcomes {#motivation-shared-evidence}
...
## Choosing actions under uncertainty {#motivation-evidence}
...
## Bayesian orchestration of AI agents {#motivation-bayesian-orchestration}
...
## Bayesian decisions with manipulated evidence {#motivation-manipulated-evidence}
...
## Bayesian inference and decision theory {#bayes-foundations .transition-slide}

::: {.transition-copy}
::: {.transition-main}
Bayesian inference<br>and decision theory
:::
:::
...
## A decision about microcredit {#bayes-start}
...
## Assumptions behind a Bayesian decision {#bayes-assumptions}
...
## Can data edits change a Bayesian analysis? {#poison-question}
...
## The attacker's control over the data {#poison-threat-model}
...
## Optimizing a posterior discrepancy {#poison-obstacles}
...
## A gradient from two expectations {#poison-gradient}
...
## Data edits change the inferred effect {#poison-mexico-attacked}
...
## Targeting selected quantities with moment kernels {#poison-moment-matching}
...
## A planning decision based on soil pollution {#poison-spatial-example}
...
## The attacker's objective {#evasion-goals}
...
## Changing the prediction {#evasion-targeted}
...
## Standard defenses as limiting cases {#defense-limits}
...
## Sequential decisions and feedback {#sequential-loop}
...
## An opponent acts in parallel {#sequential-opponent}
...
## Updating beliefs about the opponent {#sequential-belief-update .sequential-equation}
...
## Decisions made by AI agents {#llm-bayesian-control}
...
## Opponent models and states for AI agents {#llm-sequential}
