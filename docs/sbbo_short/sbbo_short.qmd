...
- **BOCS**: Bayesian second-order linear regression with heavy-tailed horseshoe prior
...
* RNA assimilated with chain of letters (A, C, G, U)

* Design RNA chain of lenght $l$ such that MFE is minized
