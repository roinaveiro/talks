...
* Generate **novel molecules by leveraging ML activity-structure relationship models with optimal properties**
...
![](iiia23_files/gp.png){ width="350" height="300" style="display: block; margin: 0 auto"}
...
* For $t=500$ iterations: 
  ...
  * Update dataset with $(x_{t_1}, y_{t+1})$
...
![](iiia23_files/_ON.png){width="800" height="600" style="display: block; margin: 0 auto"}
